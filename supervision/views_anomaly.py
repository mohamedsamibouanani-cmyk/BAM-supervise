...
from .models import (
    Anomalie, HistoriqueAnomalie, JournalAudit, Motif,
...
def anomaly_detail(request, pk):
    ...
    # Le traitement d'une anomalie reste déterministe : règles métier + décision
    # humaine. Le Machine Learning est désormais réservé à la prévision des
    # campagnes futures et n'intervient plus dans ce dossier.
                ...
                if selected_predictions:
                    for offset, prediction in enumerate(selected_predictions):
                        ...
                        if target is None:
                            continue
                        validations.append(
                            ValidationMotif.objects.create(
                                anomalie=anomaly,
