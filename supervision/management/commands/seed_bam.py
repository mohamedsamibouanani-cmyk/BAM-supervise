...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        motif_data = [
            ...
            ('FORMAT_ATTRIBUT_INCOMPATIBLE', 'Format de valeur potentiellement incompatible', 'ATTRIBUT', 'FORMAT', ''),
            ...
            ('CHAMP_OBLIGATOIRE_VIDE', 'Valeur obligatoire absente', 'ATTRIBUT', 'DONNEE', ''),
            ('ATTRIBUT_NON_SYNCHRONISE', 'Valeur d’attribut absente / non synchronisée', 'ATTRIBUT', 'SYNCHRONISATION', ''),
            ('ATTRIBUT_DIFFERENT', 'Valeur d’attribut différente / non synchronisée', 'ATTRIBUT', 'SYNCHRONISATION', ''),
